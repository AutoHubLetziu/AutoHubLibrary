...
local Utility = {}
local Objects = {}
function AutoHub:DraggingEnabled(frame, parent)
...
local themeStyles = {
    DefaultTheme = {
        ...
        Background = Color3.fromRGB(245,145,45),
...
function AutoHub.CreateLib(kavName, themeList)
    ...
    AutoHub:DraggingEnabled(MainHeader, Main)
    ...
    function AutoHub:ChangeColor(prope,color)
